...
[source,bash]
----
include::static/configs/examples/ocsExample/requisitions/computers.basic/requisition.properties[]
----

.Example configuration to import OCS SNMP devices into OpenNMS
[source,bash]
----
include::static/configs/examples/ocsExample/requisitions/snmpDevices.basic/requisition.properties[]
----
