...
[source,bash]
----
include::static/configs/examples/jdbcExample/requisitions/phpipam/requisition.properties[]
----

.Example configuration to import nodes from another OpenNMS database
[source,bash]
----
include::static/configs/examples/jdbcExample/requisitions/opennms/requisition.properties[]
----
