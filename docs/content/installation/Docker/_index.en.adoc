...
Running _PRIS_ with Docker requires a current Docker installation on your system.
...
[source, yaml]
----
include::static/configs/docker/docker-compose.yml[]
----
...
Download the latest version of _PRIS_ with `docker pull opennms/pris:latest`.
