...
image::/images/myRouter.png[myRouter.png,700]
...
image::/images/myServer.png[myServer.png,700]
...
[source,bash]
----
include::/static/configs/examples/xlsExample/global.properties[]
----
...
[source,bash]
----
include::/static/configs/examples/xlsExample/requisitions/myRouter/requisition.properties[]
----
...
It is not necessary to restart the _PRIS_ server if you change properties files or the _XLS_ file.
