...
public class EndpointApacheConfiguration extends AbstractApacheConfiguration implements EndpointConfiguration {

    private static org.apache.commons.configuration.Configuration createConfig(final Path basePath) {
        final Path path = basePath.resolve("endpoint.properties");
    ...
    public EndpointApacheConfiguration(final Path basePath,
    ...
    private EndpointApacheConfiguration(final Path basePath,
    ...
    @Override
    public EndpointConfiguration subset(final String prefix) {
        return new EndpointApacheConfiguration(this.basePath,
                                               this.endpoint,
