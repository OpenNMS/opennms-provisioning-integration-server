...
[source,bash]
----
include::../configs/examples/jdbcExample/requisitions/phpipam/requisition.properties[]
----

.Example configuration to import nodes from another OpenNMS database
[source,bash]
----
include::../configs/examples/jdbcExample/requisitions/opennms/requisition.properties[]
----
