...
[source,bash]
----
include::../examples/source/ocsExample/requisitions/computers.basic/requisition.properties[]
----

.Example configuration to import OCS SNMP devices into OpenNMS
[source,bash]
----
include::../examples/source/ocsExample/requisitions/snmpDevices.basic/requisition.properties[]
----
