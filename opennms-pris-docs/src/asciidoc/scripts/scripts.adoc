...
[source,java]
----
include::{docdir}/configs/scriptsteps/default/failOnSizeChange.groovy[]
----

The persistens of the previous requistion size is provided by the second script step of the setup.

.Example script step 8
[source,java]
----
include::{docdir}/configs/scriptsteps/default/persistRequisitionSize.groovy[]
----
