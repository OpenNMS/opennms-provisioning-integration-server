...
[source,java]
----
include::../configs/scriptsteps/requisitionRename.groovy[]
----

.Example script step 2
[source,java]
----
include::../configs/scriptsteps/IgnoreNodeByCategory.groovy[]
----

.Example script step 3
[source,java]
----
include::../configs/scriptsteps/reverseDNS.groovy[]
----
...
[source,java]
----
include::../configs/scriptsteps/sample.groovy[]
----
