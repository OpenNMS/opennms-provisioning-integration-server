...
The script steps are executed by the JVM following the JSR-223 specification. There for all JSR-223 supported languages can be used to write script steps.
