...
public class OcsSnmpDevicesSource extends AbstractOcsSource {
    ...
    public OcsSnmpDevicesSource(final InstanceConfiguration config) {
        super(config);
    }
    ...
    public Object dump() throws Exception {
        ...
        if (this.getConfig().containsKey("target")) {
            ...
            try {
                ...
                jaxbMarshaller.marshal(snmpDevices, dumpComputers.toFile());
    ...
    public static class Factory implements Source.Factory {
        ...
        public Source create(final InstanceConfiguration config) {
            return new OcsSnmpDevicesSource(config);
        }
    }
}
